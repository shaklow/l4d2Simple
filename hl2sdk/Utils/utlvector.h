...
inline void CUtlVectorUltraConservative<T, A>::EnsureCapacity(int num)
{
	int nCurCount = Count();
	if (num <= nCurCount)
	{
...
template<typename T, typename A>
inline int CUtlVectorUltraConservative<T, A>::AddToTail(const T & src)
{
	int iNew = Count();
...
template<typename T, typename A>
inline void CUtlVectorUltraConservative<T, A>::RemoveAll()
{
	if (Count())
	{
...
template<typename T, typename A>
inline void CUtlVectorUltraConservative<T, A>::PurgeAndDeleteElements()
{
	if (m_pData != StaticData())
	{
...
template<typename T, typename A>
inline void CUtlVectorUltraConservative<T, A>::FastRemove(int elem)
{
...
template<typename T, typename A>
inline void CUtlVectorUltraConservative<T, A>::Remove(int elem)
{
	Destruct(&Element(elem));
...
template<typename T, typename A>
inline int CUtlVectorUltraConservative<T, A>::Find(const T & src) const
{
	int nCount = Count();
...
template<typename T, typename A>
inline bool CUtlVectorUltraConservative<T, A>::FindAndRemove(const T & src)
{
	int elem = Find(src);
	if (elem != -1)
	{
...
template<typename T, typename A>
inline bool CUtlVectorUltraConservative<T, A>::FindAndFastRemove(const T & src)
{
	int elem = Find(src);
	if (elem != -1)
	{
